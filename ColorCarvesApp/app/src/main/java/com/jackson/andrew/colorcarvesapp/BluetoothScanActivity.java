...
public class BluetoothScanActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Determines if BLE is available on devices
    ...
    private void CheckBluetoothLowEnergy() {

        if (!mBluetoothAdapter.isEnabled()) {
            if (!mBluetoothAdapter.isEnabled()) {
                Intent enableBtIntent = new Intent(BluetoothAdapter.ACTION_REQUEST_ENABLE);
                startActivityForResult(enableBtIntent, REQUEST_ENABLE_BT);
                Log.i(TAG, "Checked Bluetooth");
    ...
    public void StartScanning() {
        if (mBluetoothAdapter.isEnabled()) {
            ...
            Log.i(TAG, "StartScanning: shuold scan for 10 seconds");
        }
    }
